...
class ModelAccountWishcat extends Model {
    public function saveCatData($name, $company_name,$email, $pdf, $product_data) {
        ...
        $this->db->query("
            ...
            (`name`, `company_name`,`email`, `pdf`, `product_data`, `status`)
            VALUES ('$name', '$company_name','$email', '$pdf', '$product_data', '0')
        ");
    }
