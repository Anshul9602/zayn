...
$(document).ready(function () {
	...
	$('#grid-view').click(function () {
		...
		if (cols == 2) {
			$('#content .product-list').attr('class', 'product-layout product-grid col-lg-3 col-xs-6');
		} else if (cols == 1) {
			$('#content .product-list').attr('class', 'product-layout product-grid col-lg-3 col-xs-6');
		} else {
			$('#content .product-list').attr('class', 'product-layout product-grid col-lg-3 col-xs-6');
	...
	'add': function (product_id) {
		$.ajax({
			...
			success: function (json) {
				...
				if (json['success']) {
					$('#wishlist-msg').text('Added to wishlist!');
					setTimeout(function () {
						$('#wishlist-msg').text('');
					}, 2000);
				}
...
$(document).ready(function () {
	...
	$("#search").click(function (e) {
		...
		$("#overlay_search").css("display", "flex");
	})
