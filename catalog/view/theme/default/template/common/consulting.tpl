    ...
    <div style="padding:0 7%;">
        <div class="row justify-content-center">
            ...
            <div class="col-md-8">
                ...
                <label for="time-zone-select">Select Time Zone:</label>
                <select id="time-zone-select"></select>
            </div>
            ...
            <script>
                ...
                // Function to get all time zones
                function getAllTimeZones() {
                    return Intl.DateTimeFormat().resolvedOptions().timeZone;
                }
            
                // Populate the select element with time zones
                ...
                if (timeZoneSelect) {
                    ...
                    // Add the user's time zone as the default option
                    const defaultOption = document.createElement('option');
                    defaultOption.value = userTimeZone;
                    defaultOption.text = `Your Time Zone: ${userTimeZone}`;
                    timeZoneSelect.add(defaultOption);
            
                    // Add all time zones to the select element
