...
<form class="form-horizontal" action="index.php?route=extension/payment/squareup/checkout" method="POST" id="squareup_card_details_form" style="display: none;">
    <div class="row">
        <div class="col-sm-12">
            <hr />
        </div>
    ...
    <fieldset>
        <?php if ($cards) { ?>
            <div class="form-group">
                <label class="col-sm-6 control-label" for="squareup_select_card"><?php echo $text_saved_card; ?></label>
                <div class="col-sm-10">
    ...
    <fieldset id="hide-card-details" <?php echo ($has_selected_card ? 'style="display: none;"' : ''); ?>>
        <?php if ($accepted_cards_status) { ?>
            <div class="form-group">
                <label class="col-sm-6 control-label"><?php echo $text_accepted_cards; ?></label>
                <div class="col-sm-10">
        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="form-group">
                    <label class="col-sm-12 control-label" for="id_card_number"><?php echo $text_card_number; ?></label>
                    <div class="col-sm-12">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    <label class="col-sm-12 control-label" for="id_card_expiry"><?php echo $text_card_expiry; ?></label>
                    <div class="col-sm-12">
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label class="col-sm-12 control-label" for="id_cvc"><?php echo $text_card_cvc; ?></label>
                    <div class="col-sm-12">
                        <div id="id_cvc"></div>
                    </div>
                </div>
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label class="col-sm-12 control-label" for="id_card_zip_code"><?php echo $text_card_zip; ?></label>
                    <div class="col-sm-12">
        ...
        <?php if ($is_logged) { ?>
            <?php if ($has_recurring_products) { ?>
                <div class="form-group">
                    <label class="col-sm-6 control-label" for="squareup_save_card"><?php echo $text_card_save; ?></label>
                    <div class="col-sm-5">
    ...
    <div class="buttons">
        <div class="pull-right">
            <button id="button-confirm-order" class="btn btn-hero">
