...
<?php } ?>
<form style="width: 100%;" action="<?php echo $action; ?>" method="post">
  ...
  <div style="width: 100%;" class="buttons">
    <div style="float: right; width: 100%;" class="pull-right">
      <button style="float: right;" type="submit" class="btn btn-hero">
