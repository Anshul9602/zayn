...
.specColWidth.specFirstRow .specName {
...
<link href="catalog/view/theme/default/stylesheet/magnify.css" rel="stylesheet"
   type="text/css">
...
<div class="confrim_pop">
   ...
   <br>
   <a href="index.php?route=checkout/cart"><button
         class="btn btn-hero">Checkout</button></a>
   <button id="continue_shopping" class="btn btn-hero">Continue
      Shopping</button>
</div>

<div style="margin-top:10px;" class=" mt-md-4">
   <div class="container">
      <div class="row">
         <div class="col-sm-12">
            <div style="margin-bottom: 100px;" class="row">
               <div style="padding:0px; max-width:200px; text-align:left"
                  class="col-sm-2 desktop_slider">
                  <ul class="slider slider-nav ">
                     <?php if ($thumb) { ?>
                     <li style="outline:none"><img style="margin: auto -5px"
                           class="img-responsive nav-list-li"
                           src="<?php echo $thumb; ?>"
               ...
               <div style="padding:0px" class="col-sm-5 desktop_slider">
                  ...
                  <div id="s_wrap">
                     <ul class="slider slider-for">
                        <?php if ($thumb) { ?>
                        <li class="zoom"><img class="img-responsive"
                     ...
                     <div class="col-sm-12">
                        ...
                        <div class="tab-content">
                           ...
                           <div class="tab-pane" id="tab-specification">
                              <div class="product_specSection w-100">

                                 <div id="full_specification"
                                    class=" mt-2 full_specSection specification_row borderBottom_e4">

                                    <ul class="specListWrap">

                                       <li class="specColWidth specFirstRow">
                                          <div class="specCol"><span
                                                class="specName">Brand</span>
                                             <span class="specValue">
                                                <a
                                                   href="https://www.ethoswatches.com/brands/hublot.html"
                                                   title="Hublot">Hublot</a></span>
                                          </div>
                                          <div class="specCol"><span
                                                class="specName">Collection</span><span
                                                class="specValue">Classic
                                                Fusion</span></div>
                                          <div class="specCol"><span
                                                class="specName">Series</span><span
                                                class="specValue">3-Hands</span></div>
                                          <div class="specCol"><span
                                                class="specName">Model
                                                No</span><span
                                                class="specValue">565.NX.1470.LR.1204</span></div>
                                       </li>

                                       <li class="specColWidth">

                                          <div class="specCol">
                                             <div class="specColRowWrap">
                                                <span
                                                   class="specHeading">Movement</span>
                                                <div class="specRow">
                                                   <span
                                                      class="specName">Features</span>
                                                   <span
                                                      class="specValue">Date</span>
                                                </div>
                                                <div class="specRow">
                                                   <span
                                                      class="specName">Movement</span>
                                                   <span
                                                      class="specValue">Automatic</span>
                                                </div>
                                                <div class="specRow">
                                                   <span
                                                      class="specName">Calibre</span>
                                                   <span
                                                      class="specValue">HUB1110</span>
                                                </div>
                                             </div>
                                          </div>
                                          ...
                                          <div class="specCol">
                                             <div class="specColRowWrap">
                                                <span
                                                   class="specHeading">Case</span>

                                                <div class="specRow">
                                                   <span class="specName">Case
                                                      Size</span>
                                                   <span class="specValue">38
                                                      mm</span>
                                                </div>
                                                <div class="specRow">
                                                   <span class="specName">Case
                                                      Shape</span>
                                                   <span
                                                      class="specValue">Round</span>
                                                </div>
                                                <div class="specRow">
                                                   <span class="specName">Case
                                                      Material</span>
                                                   <span
                                                      class="specValue">Titanium</span>
                                                </div>
                                                <div class="specRow">
                                                   <span class="specName">Glass
                                                      Material</span>
                                                   <span
                                                      class="specValue">Sapphire
                                                      Crystal</span>
                                                </div>
                                          ...
                                          <div class="specCol">
                                             <div class="specColRowWrap">
                                                <span
                                                   class="specHeading">Dial</span>
                                                <div class="specRow">
                                                   <span class="specName">Dial
                                                      Colour</span>
                                                   <span
                                                      class="specValue">Black</span>
                                                </div>
                                             </div>
                                          </div>
                                          ...
                                          <div class="specCol">
                                             ...
                                             <div class="specColRowWrap">
                                                <span
                                                   class="specHeading">Strap</span>
                                                <div class="specRow">
                                                   <span class="specName">Strap
                                                      Material</span>
                                                   <span
                                                      class="specValue">Rubber
                                                      &amp; Leather</span>
                                                </div>
                                                <div class="specRow">
                                                   <span class="specName">Strap
                                                ...
                                                <div class="specRow">
                                                   <span class="specName">Clasp
                                                      Type</span>
                                                   <span
                                                      class="specValue">Deployment
                                                      Clasp</span>
                                                </div>
                                             </div>
                                             ...
                                             <div class="specColRowWrap">
                                                <span
                                                   class="specHeading">Other</span>

                                                <div class="specRow">
                                                   <span
                                                      class="specName">Precious
                                                      Stone</span>
                                                   <span class="specValue">
                                                      On Bezel
                                                   </span>
                                                ...
                                                <div class="specRow">
                                                   <span
                                                      class="specName">Gender</span>
                                                   <span class="specValue">
                                                      Men
                                                   </span>
                                                </div>
                                                <div class="specRow">
                                                   <span class="specName">Water
                                                      Resistance (M)</span>
                                                   <span class="specValue">
                                                      50
                                                   </span>
                           ...
                           <div class="tab-pane" id="tab-review">
                              <form class="form-horizontal" id="form-review">
                                 ...
                                 <div class="form-group required">
                                    <div class="col-sm-12">
                                       <span
                                          class="star-cb-group star-rating star-5">
                                          <label class="control-label">
               ...
               <div class="col-xs-12 slider-mob-box"
                  ...
                  <div>
                     <ul class="slider-mob" style="z-index:99999">
                        ...
                        <?php if ($images) { ?>
                        <?php foreach ($images as $image) { ?>
                        <li><img class="img-responsive" style="margin: auto;"
                              src="<?php echo $image['popup']; ?>"
                              title="<?php echo $heading_title; ?>"
                              alt="<?php echo $heading_title; ?>" /></li>
                        <?php
               ...
               <div style=" text-align:left" id="product"
                  ...
                  <h3 class="product_font"
                     style="text-transform: capitalize; color:#000; font-size:28px; margin-top:25px">
                  ...
                  <div class="row">
                     ...
                     <?php
                     $wishlist_items1_array = json_decode($wishlist_items1,
                     true);
                     ...
                     <div class="col-md-2">
                        ...
                        <a
                           style="float:right;  padding:12px;    margin-top: 10px;"
                           class="btn btn-find-store "><i
                  ...
                  <div style="margin-top:20px; display:none" class="row">
                     <div
                        style="text-align: left; padding-left: 0px; width:120px">
                        <p style="color:#000; font-size:16px">Quantity
                           &nbsp;&nbsp;&nbsp;&nbsp;</p>
                        <div style="text-align: left; padding-left: 0px; "
                           ...
                           <span class="minus-btn" id="less_quantity"
                              ...
                              <input style="margin: 0px; padding: 2.5px;"
                                 type="hidden" name="product_id"
                                 value="<?php echo $product_id; ?>" />
                              <li style="color: #333; font-size: 12px"
                                 class="fa fa-minus"></li>
                           </span>
                        </div>
                        <div style="text-align: center; padding: 0px"
                           class="col-sm-4 col-xs-2">
                           <input
                              ...
                              type="text" readonly name="quantity" value="1"
                        ...
                        <div style="text-align: left; padding-left: 0px; "
                           ...
                           <span class="pluse-btn" id="add_quantity"
                              ...
                              <li style="font-size: 12px; color:#000"
                                 class="fa fa-plus"></li>
                           </span>
                        </div>
                     </div>
                  ...
                  <div class="text-center" style="display: inline-block;">
                     <span
                        style="background:url(<?php echo $option_value['image']; ?>)"
                     ...
                     <div
                        ...
                        <div class="radio">
                           <label>
                              <input class="sizes"
                                 data-sign="<?php echo $option_value['price_prefix']; ?>"
                                 data-price="<?php echo $option_value['price']; ?>"
                                 type="radio"
                                 name="option[<?php echo $option['product_option_id']; ?>]"
                                 value="<?php echo $option_value['product_option_value_id']; ?>" />
                  ...
                  <div style="padding:0px;" id="content" class="row">
                     <div style=" min-width:160px;" id="addb" class="col-sm-7">
                        <a id="button-cart" style="width: 100%;"
                           class="btn btn-hero">ADD TO CART</a>
                     </div>
                     <div class="col-sm-5">
                        <a class="btn btn-find-store" style
                           href="https://zaynjewels.com/index.php?route=common/locations">Find
                           A Store</a>
                  ...
                  <div style="padding:0px;" class="row">
                     <div style=" min-width:160px;" id="addb" class="col-sm-10">
                        <a style="width: 100%;" id="login-redirect"
                           class="btn btn-hero">
                           Retailer Login</a>
                     </div>
                     ...
                     <div class="col-sm-12">
                        <ul class="nav nav-tabs"
                           ...
                           <li style="display:inline-block" class="active"><a
                                 href="#tab-description-mob"
                                 data-toggle="tab">
                                 <?php echo strip_tags($tab_description); ?>
                              </a></li>
                           <?php if ($attribute_groups) { ?>
                           <li style="display:inline-block"><a
                                 href="#tab-specification-mob"
                                 data-toggle="tab">
                                 <?php echo $tab_attribute; ?>
                              </a></li>
                           <?php
                           ...
                           <?php if ($review_status) { ?>
                           <li style="display:inline-block"><a
                                 href="#tab-review-mob" data-toggle="tab">
                                 <?php echo $tab_review; ?>
                              </a></li>
                           <?php
                           } ?>
                        ...
                        <div class="tab-content">
                           ...
                           <div class="tab-pane" id="tab-specification-mob">
                              <table class="table table-bordered">
                                 <?php foreach ($attribute_groups as
                                 $attribute_group) { ?>
                                 <thead>
                                    <tr>
                                       <td colspan="2"><strong>
            ...
            <a href="<?php print_r($product['href']); ?>">
               ...
               <div class="product-item">
                  <figure class="product-thumb">
                     <a href="<?php print_r($product['href']); ?>">
                        <img style="z-index:99999999"
                           src="<?php print_r($product['thumb']); ?>"
   ...
   <div class="row">
      <div class="col-sm-12">
         <div style="margin-bottom: 50px; display:flex; align-items:center"
            ...
            <div class="col-sm-6">
               <h3
                  style="text-transform: capitalize; color:#423c9e; font-size:28px; margin-top:25px">
                  <?php echo $heading_title; ?>
               </h3>
               <br />
               ...
               <h3 style="color:#a38129; font-size:22px;">
                  ...
                  echo '<div style="padding:0px;" class="row pb-5">
                     <div style=" min-width:160px;" id="addb"
                        class="col-sm-6 offset-sm-3">
                        <a style="width: 100%;" id="login-redirect"
                           class="btn btn-hero">LOGIN</a>
                     </div>
            ...
            <div class="col-12 slider-mob-box">
               <div>
                  <ul class="slider-mob" style="z-index:99999">
                     <?php if ($thumb) { ?>
                     <li style="margin-left:-30px"><img class="img-responsive"
                           src="<?php echo $thumb; ?>"
                           title="<?php echo $heading_title; ?>"
                           alt="<?php echo $heading_title; ?>" /></li>
                     <?php
         ...
         <div id="content" style="min-height: 350px;"
            ...
            <div style=" text-align:left" id="product" class="col-sm-12 mb-3">
               ...
               <div class="tab-content" id="myTabContent">
                     ...
                     <div class="row" style="margin-top:20px">
                        ...
                        <?= $option['name'] ?></label> -->
                              <input type="text"
                                 ...
                                 value="<?= ($draft && isset($draft[" option[" .
                  ...
                  <div class="tab-pane fade text-center" id="profile"
                     ...
                     <div class="row" style="margin-top:20px">
                        ...
                        <div class="col-sm-6"
                           ...
                           <p style="display: none;">Metal Colors</p>
                           <?php foreach ($options[$i]['product_option_value']
                           as $option_value) { ?>
                           <div class="text-center"
                              style="display: inline-block;">
                              <span
                                 style="background:url(<?= $option_value['image'] ?>)"
                                 data-sign="<?= $option_value['price_prefix'] ?>"
                                 data-money="<?= $option_value['price'] ?>"
                                 data-image="<?= $option_value['option_image'] ?>"
                                 data-val="<?= $option_value['product_option_value_id'] ?>"
                                 class="tab_options">
                           ...
                           <div style="display: none;" style="width:200px;"
                              ...
                              <select
                                 ...
                                 <?php foreach
                                 ($options[$i]['product_option_value'] as
                                 $option_value) { ?>
                                 <option
                                    data-sign="<?= $option_value['price_prefix'] ?>"
                        ...
                        <div class="col-sm-6"
                           style="min-height:50px; margin-bottom:20px; border-bottom:1px solid #ccc; padding-bottom:20px">
                           <div
                              class="text-left form-group<?= $options[$i]['required'] ? ' required' : '' ?>">
                              <label class="control-label">
                                 <?= $options[$i]['name'] ?>
                              </label>
                              <div
                  ...
                  <div class="tab-pane fade text-center" id="contact"
                     ...
                     <div class="row" style="margin-top:20px">
                        ...
                        <div class="col-sm-6"
                           style="min-height:50px; margin-bottom:20px;">
                           <div
                              class="text-left form-group<?= $options[$i]['required'] ? ' required' : '' ?>">
                              <label class="control-label">
                                 <?= $options[$i]['name'] ?>
                              ...
                              <input type="hidden"
                                 ...
                                 value
                                 id="input-option<?= $options[$i]['product_option_id'] ?>" />
                              <span style="font-style:italic">(Maximum file size
                                 5 MB Allowed)</span>
      ...
      <div class="row d-none">
         ...
         <div style=" text-align:left" id="product1" class="col-sm-12 mb-3">
            <div style="margin-top:20px; display:none" class="row">
               <div style="text-align: left; padding-left: 0px; width:120px">
                  ...
                  <div style="text-align: center; padding: 0px"
                     ...
                     <input
                        style="text-align: center; border-radius:0px; color:#000; width: auto; height: auto; box-shadow:none; border: none; background-color: transparent; padding: 0px"
                        type="text" readonly name="quantity" value="1" size="2"
                        id="input-quantity"
                        class="form-control" />
                  </div>
                  <div style="text-align: left; padding-left: 0px; "
            ...
            <div
               class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
               <label class="control-label">
                  <?php echo $option['name']; ?> (Maximum file size 5 MB
                  Allowed))
               </label>
               <button style="width:100px" type="button"
                  id="button-upload<?php echo $option['product_option_id']; ?>"
            ...
            <div class="text-center" style="display: inline-block;">
               <span
                  ...
                  data-val="<?php echo $option_value['product_option_value_id']; ?>"
                  class="tab_options">
