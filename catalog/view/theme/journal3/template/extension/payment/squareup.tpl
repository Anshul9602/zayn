...
<form id="payment-form" action="<?php echo $action; ?>">
	...
	<fieldset class="tab-pane" id="tab-card_details">
        <?php if ($cards) { ?>
	...
	<fieldset <?php echo $has_selected_card ? 'class="tab-pane"' : 'class="tab-pane active"'; ?> id="hide-card-details">
	...
	<?php if ($squareup_google_pay_status) { ?>
	<fieldset class="tab-pane" id="tab-gPay">
	<div id="google-pay-button"></div>
	</fieldset>
	<?php } ?>
	<?php if ($squareup_apple_pay_status) { ?>
    <fieldset class="tab-pane" id="tab-aPay">
	<div id="apple-pay-button"></div>
	</fieldset>
	<?php } ?>
	<?php if ($squareup_after_pay_status) { ?>
    <fieldset class="tab-pane" id="tab-afterpay">
	<div id="afterpay-button"></div>
	</fieldset>
	<?php } ?>
	<?php if ($squareup_gift_card_status) { ?>
    <fieldset class="tab-pane" id="tab-gift-card">
