...
class ControllerExtensionDBlogModulecategory2 extends Controller
{
    ...
    public function index()
    {
        ...
        if ($category_info) {
            ...
            $category_info['meta_title'] = "Blogs";
        ...
        //metas
        $this->document->setTitle('Zayn Blog');
        ...
        $this->response->setOutput($this->model_extension_d_opencart_patch_load->view('extension/d_blog_module/category2', $data));
    }
