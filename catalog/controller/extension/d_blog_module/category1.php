...
class ControllerExtensionDBlogModuleCategory1 extends Controller
{
    ...
    public function index()
    {
        ...
        $this->response->setOutput($this->model_extension_d_opencart_patch_load->view('extension/d_blog_module/category1', $data));
    }
