<?php
class ControllerCommonGiadiamonds extends Controller
{
	public function index()
	{
		...
		foreach ($results as $result) {
			$data['wishlist_products'][] =	$result['product_id'];
		}
		...
		// 	echo ("</pre>");
		$this->response->setOutput($this->load->view('common/giadiamonds', $data));
	}
}
