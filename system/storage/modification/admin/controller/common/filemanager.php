...
class ControllerCommonFileManager extends Controller {
				...
				public function index() {
					...
					$data = $this->language->load('extension/elfinder');
					...
					$data['el_setting'] = $this->load->controller('extension/elfinder/getsetting');

					$data['modal'] = true;
					$data['iframe'] = false;

					$data['thumb_image'] = !empty($this->request->get['thumb']) ? $this->request->get['thumb'] : '';
					$data['target_image'] = !empty($this->request->get['target']) ? $this->request->get['target'] : '';
					$data['multiple'] = !empty($this->request->get['multiple']) ? $this->request->get['multiple'] : '';
					$data['CKEditor'] = !empty($this->request->get['CKEditor']) ? $this->request->get['CKEditor'] : '';
					$data['CKEditorFuncNum'] = !empty($this->request->get['CKEditorFuncNum']) ? $this->request->get['CKEditorFuncNum'] : '';

					$data['version'] = $this->load->controller('extension/elfinder/getversion');
					...
					$params = !empty($this->request->get) ? $this->request->get : array($data['token_name'] => $data['user_token']);

					if (isset($params['route'])) {
						unset($params['route']);
					}

					$data['iframe_link'] = $this->url->link('common/filemanager/el_iframe', http_build_query($params), true);
