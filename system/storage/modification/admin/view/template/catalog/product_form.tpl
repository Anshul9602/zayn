        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-model">Style No.</label>
                <div class="col-sm-10">
                  <input type="text" name="model" value="<?php echo $model; ?>" placeholder="Style No." id="input-model" class="form-control" />
                  <?php if ($error_model) { ?>
              ...
              <div class="form-group">
               ...
               <?php if($_GET['gia']!='1'){?>
                 <label class="col-sm-2 control-label" for="input-sku"><span data-toggle="tooltip" title="<?php echo $help_sku; ?>">Design No.</span></label>
                 <div class="col-sm-10">
                  <input type="text" name="sku" value="<?php echo $sku; ?>" placeholder="Design No." id="input-sku" class="form-control" />
                 </div>
                <?php }else{?>
                  <label class="col-sm-2 control-label" for="input-sku"><span data-toggle="tooltip" title="Fluorescence">Fluorescence</span></label>
                  <div class="col-sm-10">
                  <input type="text" name="sku" value="<?php echo $sku; ?>" placeholder="Fluorescence" id="input-sku" class="form-control" />
                  </div>
                <?php }?>  
              ...
              <div class="form-group">
              <?php if($_GET['gia']!='1'){?>   
                <label class="col-sm-2 control-label" for="input-upc"><span data-toggle="tooltip" title="<?php echo $help_upc; ?>">Metal Purity</span></label>
                 <div class="col-sm-10">
                  <input type="text" name="upc" value="<?php echo $upc; ?>" placeholder="Metal Purity" id="input-upc" class="form-control" />
                </div>
              <?php }else{?>
                 <label class="col-sm-2 control-label" for="input-upc"><span data-toggle="tooltip" title="Carat Weight">Carat Weight</span></label>
                  <div class="col-sm-10">
                  <input type="text" name="upc" value="<?php echo $upc; ?>" placeholder="Carat Weight" id="input-upc" class="form-control" />
                 </div>
                <?php }?>
              </div>
              <div class="form-group">
              <?php if($_GET['gia']!='1'){?>    
                 <label class="col-sm-2 control-label" for="input-ean"><span title="<?php echo $help_ean; ?>">Tag Line</span></label>
                  <div class="col-sm-10">
                  <input type="text" name="ean" value="<?php echo $ean; ?>" placeholder="Tag Line" id="input-ean" class="form-control" />
                  </div>
               <?php }else{?>
                  <label class="col-sm-2 control-label" for="input-ean"><span title="<?php echo $help_ean; ?>">Color</span></label>
                  <div class="col-sm-10">
                  <input type="text" name="ean" value="<?php echo $ean; ?>" placeholder="Color" id="input-ean" class="form-control" />
                  </div>
                <?php }?>
              </div>
              <?php if($_GET['gia']!='1'){?>
              <div style="display:none" class="form-group">
                <label class="col-sm-2 control-label" for="input-jan"><span title="<?php echo $help_jan; ?>"><?php echo $entry_jan; ?></span></label>
                <div class="col-sm-10">
              ...
              <?php }else{?>
                <div class="form-group">
                <label class="col-sm-2 control-label" for="input-jan"><span title="Length/Width Ratio">Length/Width Ratio</span></label>
                <div class="col-sm-10">
                  <input type="text" name="jan" value="<?php echo $jan; ?>" placeholder="Length/Width Ratio" id="input-jan" class="form-control" />
                </div>
              </div>
                <?php }?>
              ...
              <div class="form-group">
              <?php if($_GET['gia']!='1'){?>     
                <label class="col-sm-2 control-label" for="input-isbn"><span title="<?php echo $help_isbn; ?>">Gold Wt. (gms)</span></label>
                <div class="col-sm-10">
                  <input type="text" name="isbn" value="<?php echo $isbn; ?>" placeholder="Gold Wt. (gms)" id="input-isbn" class="form-control" />
                </div>
              <?php }else{?>
                <label class="col-sm-2 control-label" for="input-isbn"><span title="<?php echo $help_isbn; ?>">Cut</span></label>
                <div class="col-sm-10">
                  <input type="text" name="isbn" value="<?php echo $isbn; ?>" placeholder="Cut" id="input-isbn" class="form-control" />
                </div>
              <?php }?>
              </div>
              <div class="form-group">
              <?php if($_GET['gia']!='1'){?>       
                <label class="col-sm-2 control-label" for="input-mpn"><span title="<?php echo $help_mpn; ?>">Stone Wt (cts)</span></label>
                <div class="col-sm-10">
                  <input type="text" name="mpn" value="<?php echo $mpn; ?>" placeholder="Stone Wt (cts)" id="input-mpn" class="form-control" />
                 </div>
               <?php }else{?>
                  <label class="col-sm-2 control-label" for="input-mpn"><span title="<?php echo $help_mpn; ?>">Shape</span></label>
                  <div class="col-sm-10">
                    <input type="text" name="mpn" value="<?php echo $mpn; ?>" placeholder="Shape" id="input-mpn" class="form-control" />
                  </div>
               <?php }?>
              </div>
              <div class="form-group">
              <?php if($_GET['gia']!='1'){?> 
                <label class="col-sm-2 control-label" for="input-location">Product Unit</label>
                <div class="col-sm-10">
                  <input type="text" name="location" value="<?php echo $location; ?>" placeholder="Product Unit" id="input-location" class="form-control" />
                </div>
                <?php }else{?>
                  <label class="col-sm-2 control-label" for="input-location">Clarity</label>
                  <div class="col-sm-10">
                    <input type="text" name="location" value="<?php echo $location; ?>" placeholder="Clarity" id="input-location" class="form-control" />
                  </div>  
                <?php }?>
              </div>
              <div class="form-group">
              ...
              <script>
                $("#input-model").bind("paste", function(e) {
                  // access the clipboard using the api
                  var pastedData = e.originalEvent.clipboardData.getData('text');
                  $("#input-keyword").val(pastedData);
                });
                $("#input-model").keyup(function() {
                  $("#input-keyword").val($("#input-model").val());
                })
              </script>
              <div style="display:none" class="form-group">
                ...
                <div class="col-sm-3">
                  <div class="input-group date">
                    <input type="text" name="date_available" value="2010-10-18" placeholder="<?php echo $entry_date_available; ?>" data-date-format="YYYY-MM-DD" id="input-date-available" class="form-control" />
            ...
            <div class="tab-pane" id="tab-links">
              ...
              <div class="form-group">
               <?php if($_GET['gia'] == '1'){?>
                <input type="hidden" name="gia" value="true" />
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="related" value="" placeholder="<?php echo $entry_related; ?>" id="filter_model" class="form-control" />
                              ...
                              <tbody>
                                <?php foreach ($product_option['product_option_value'] as $product_option_value) { ?>
                                  <tr id="option-value-row<?php echo $option_value_row; ?>">
                                    ...
                                    <td><input type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][link]" value="<?php echo $product_option_value['link']; ?>" placeholder="Link" class="form-control" /></td>
