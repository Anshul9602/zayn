...
namespace vendor\isenselabs\Squareup\Diff;

use vendor\isenselabs\Squareup\Library;
...
class OpenCartProduct extends Library {
    ...
    public function insertUpdate() {
        ...
        $this->squareup_diff->chunkedMap($sql, function(&$item) use (&$total, &$batchItemCount, &$batch) {
            ...
            if (false !== $product_info['modifier_list_info'] && !$this->config->get('squareup_ad_hoc_sync')) {
