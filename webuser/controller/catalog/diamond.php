...
class ControllerCatalogDiamond extends Controller
{
	...
	protected function getList()
	{
		...
		$data['copy'] = $this->url->link('catalog/diamond/copy', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('catalog/diamond/delete', 'token=' . $this->session->data['token'] . $url, true);
		...
		$product_total = $this->model_catalog_product->getTotalDiamondProducts($filter_data);

		$results = $this->model_catalog_product->getDiamondProducts($filter_data);
