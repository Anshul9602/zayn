...
class ControllerCatalogProduct extends Controller
{
	...
	public function add()
	{
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			if($this->request->post['gia']){
				$this->response->redirect($this->url->link('catalog/giadiamond', 'token=' . $this->session->data['token'] . $url, true));
			}else{
	...
	protected function getList()
	{
		...
		$data['download_inventory'] = $this->url->link('tool/export_import/download_inventory', 'token=' . $this->session->data['token'] . $url, true);
		$data['upload_inventory'] = $this->url->link('tool/export_import/upload_inventory', 'token=' . $this->session->data['token'] . $url, true);
